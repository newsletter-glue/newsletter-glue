...
<div class="ngl-embed <?php if ( ! is_admin() && ! defined( 'REST_REQUEST' ) ) echo 'ngl-embed-frontend'; ?>" data-block-id="<?php echo esc_attr( $block_id ); ?>">
	...
	<div class="ngl-embed-input">
		<input type="text" class="<?php if ( $url ) echo 'ngl-embed-input-small'; ?>" name="ngl_embed_url" id="ngl_embed_url" placeholder="<?php echo __( 'Paste link here', 'newsletter-glue' ); ?>" value="<?php echo $url; ?>" />
	</div>
