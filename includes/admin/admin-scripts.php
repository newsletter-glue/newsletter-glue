...
function newsletterglue_load_admin_scripts( $hook ) {
	...
	if ( in_array( $screen_id, newsletterglue_get_screen_ids() ) || strstr( $screen_id, 'ngl-' ) ) {
		...
		wp_localize_script( 'newsletterglue_admin', 'newsletterglue_params', apply_filters( 'newsletterglue_admin_js_params', array(
			...
			'pattern_edit'		=> '<div class="ngl-pattern-row" style="margin: 4px 0;color: #333;opacity: 1;display:flex;align-items:center;">' . __( 'You&rsquo;re about to edit a default pattern. Consider duplicating the default pattern instead?', 'newsletter-glue' ) . '<a href="#" class="ngl-pattern-bk" style="display: flex;width: 18px;margin: 0 0 0 6px;height: 18px; position: relative; top: 1px;"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="#666"><path fill="none" d="M0 0h24v24H0z"/><path d="M12 22C6.477 22 2 17.523 2 12S6.477 2 12 2s10 4.477 10 10-4.477 10-10 10zm0-2a8 8 0 1 0 0-16 8 8 0 0 0 0 16zm0-9.414l2.828-2.829 1.415 1.415L13.414 12l2.829 2.828-1.415 1.415L12 13.414l-2.828 2.829-1.415-1.415L10.586 12 7.757 9.172l1.415-1.415L12 10.586z"/></svg></a></div>',
		) ) );
