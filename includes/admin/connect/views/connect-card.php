...
<div class="ngl-cards">
	...
	if ( ! empty( $integrations ) ) {
		foreach( $integrations as $key => $data ) {
			$app = $data[ 'esp' ];
		?>
		<div class="ngl-card" data-key="<?php echo absint( $key ); ?>">
			<div class="ngl-card-view ngl-card-view-<?php echo esc_attr( $app ); ?>" data-app="<?php echo esc_attr( $app ); ?>">
	...
	<div class="ngl-card">
		...
		<!-- Software forms -->
		<?php foreach( newsletterglue_get_supported_apps() as $app => $value ) : $key = 'increment'; ?>
			...
			<div class="ngl-card-view ngl-card-view-<?php echo esc_attr( $app ); ?> ngl-hidden" data-app="<?php echo esc_attr( $app ); ?>">
	...
	<div class="ngl-card ngl-card-masked">
