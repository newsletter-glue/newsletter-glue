...
<section class="wp-block-newsletterglue-callout undefined not-color-set" style="background-color:#f9f9f9;border-color:#eeeeee;border-style:solid;border-width:0;padding-top:0;padding-bottom:0;padding-left:0;padding-right:0;text-align:left;margin-left:0;margin-right:0"><!-- wp:spacer {"height":30} -->
...
<!-- /wp:paragraph -->'
		...
		$patterns[ 'header_2' ] = array(
			...
			'category' 	=> 'ngl_headers',
			'content'	=> '<!-- wp:newsletterglue/callout {"cta_padding":0,"cta_padding2":0} -->
<section class="wp-block-newsletterglue-callout undefined not-color-set" style="background-color:#f9f9f9;border-color:#eeeeee;border-style:solid;border-width:0;padding-top:0;padding-bottom:0;padding-left:0;padding-right:0;text-align:left;margin-left:0;margin-right:0"><!-- wp:paragraph {"align":"right","style":{"color":{"text":"#707070"},"typography":{"fontSize":14}}} -->
...
<section class="wp-block-newsletterglue-callout undefined not-color-set" style="background-color:#f9f9f9;border-color:#eeeeee;border-style:solid;border-width:0;padding-top:40px;padding-bottom:40px;padding-left:40px;padding-right:40px;text-align:left;margin-left:0;margin-right:0"><!-- wp:image {"align":"center","width":' . $logo_s_w . ',"height":' . $logo_s_h . ',"sizeSlug":"large"} -->
...
<section class="wp-block-newsletterglue-callout undefined not-color-set" style="background-color:#0088a0;border-color:#eeeeee;border-style:solid;border-width:0;padding-top:30px;padding-bottom:30px;padding-left:40px;padding-right:40px;text-align:left;margin-left:0;margin-right:0"><!-- wp:columns {"verticalAlignment":"center"} -->
...
<div class="wp-block-newsletterglue-metadata ngl-metadata" style="color:#FFFFFF;text-align:right;font-size:12px"><div class="ngl-metadata-issue">Issue #</div><div class="ngl-metadata-sep">|</div><div class="ngl-metadata-readtime">Reading time:</div><div class="ngl-metadata-readtime-ajax">1 mins</div><div class="ngl-metadata-sep">|</div><a class="ngl-metadata-permalink" href="{{ webversion }}">Read online</a><img class="ngl-metadata-permalink-arrow" src="' . NGL_PLUGIN_URL . 'includes/blocks/newsletterglue_block_metadata/img/arrow.png"/></div>
...
<div class="wp-block-newsletterglue-metadata ngl-metadata" style="color:#666666;text-align:center;font-size:12px"><div class="ngl-metadata-issue">Issue #</div><div class="ngl-metadata-sep">|</div><div class="ngl-metadata-readtime">Reading time:</div><div class="ngl-metadata-readtime-ajax">1 mins</div><div class="ngl-metadata-sep">|</div><a class="ngl-metadata-permalink" href="{{ blog_post }}">Read online</a><img class="ngl-metadata-permalink-arrow" src="' . NGL_PLUGIN_URL . 'includes/blocks/newsletterglue_block_metadata/img/arrow.png"/></div>
<!-- /wp:newsletterglue/metadata -->
...
<div class="wp-block-newsletterglue-metadata ngl-metadata" style="color:#666666;text-align:left;font-size:12px"><div class="ngl-metadata-issue">Issue #</div><div class="ngl-metadata-sep">|</div><div class="ngl-metadata-readtime">Reading time:</div><div class="ngl-metadata-readtime-ajax">1 mins</div><div class="ngl-metadata-sep">|</div><a class="ngl-metadata-permalink" href="{{ blog_post }}">Read online</a><img class="ngl-metadata-permalink-arrow" src="' . NGL_PLUGIN_URL . 'includes/blocks/newsletterglue_block_metadata/img/arrow.png"/></div>
<!-- /wp:newsletterglue/metadata -->
...
<section class="wp-block-newsletterglue-callout undefined is-color-set" style="background-color:#0d566c;color:#FFFFFF;border-color:#eeeeee;border-style:solid;border-width:0;padding-top:20px;padding-bottom:20px;padding-left:30px;padding-right:30px;text-align:left;margin-left:0;margin-right:0"><!-- wp:image {"align":"right","width":135,"height":41,"sizeSlug":"large"} -->
...
<!-- wp:newsletterglue/metadata {"text_color":"#FFFFFF","alignment":"left","date_format":"l, j M Y","show_author":false,"show_date":false,"show_location":false,"post_id":"513","readingtime":"1 mins","post_date":"Monday, 5 Jul 2021"} -->
<div class="wp-block-newsletterglue-metadata ngl-metadata" style="color:#FFFFFF;text-align:left;font-size:12px"><div class="ngl-metadata-issue">Issue #</div><div class="ngl-metadata-sep">|</div><div class="ngl-metadata-readtime">Reading time:</div><div class="ngl-metadata-readtime-ajax">1 mins</div><div class="ngl-metadata-sep">|</div><a class="ngl-metadata-permalink" href="{{ blog_post }}">Read online</a><img class="ngl-metadata-permalink-arrow" src="' . NGL_PLUGIN_URL . 'includes/blocks/newsletterglue_block_metadata/img/arrow.png"/></div>
...
<section class="wp-block-newsletterglue-callout undefined is-color-set" style="background-color:#f9f9f9;color:#707070;border-color:#eeeeee;border-style:solid;border-width:0;padding-top:30px;padding-bottom:30px;padding-left:40px;padding-right:40px;text-align:left;margin-left:0;margin-right:0"><!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":13},"color":{"text":"#707070"}}} -->
...
<section class="wp-block-newsletterglue-callout undefined not-color-set" style="background-color:#f9f9f9;border-color:#eeeeee;border-style:solid;border-width:0;padding-top:30px;padding-bottom:30px;padding-left:30px;padding-right:30px;text-align:left;margin-left:0;margin-right:0"><!-- wp:paragraph {"align":"center","style":{"typography":{"fontSize":13},"color":{"text":"#707070"}}} -->
<p class="has-text-align-center has-text-color" style="color:#707070;font-size:13px">Built with <a rel="noreferrer noopener" href="https://newsletterglue.com/?utm_source=newsletter&utm_medium=ng-signature" target="_blank">Newsletter Glue</a>.</p>
<!-- /wp:paragraph -->
...
<section class="wp-block-newsletterglue-callout undefined is-color-set" style="background-color:#0d566c;color:#FFFFFF;border-color:#eeeeee;border-style:solid;border-width:0;padding-top:30px;padding-bottom:30px;padding-left:40px;padding-right:40px;text-align:left;margin-left:0;margin-right:0"><!-- wp:newsletterglue/share {"alignment":"right","icon_size":20,"icon_shape":"default","icon_color":"white","add_description":false} -->
...
<!-- wp:newsletterglue/callout {"bg_color":"#0d566c","font_color":"#FFFFFF","cta_padding":30,"cta_padding2":40} -->
<section class="wp-block-newsletterglue-callout undefined is-color-set" style="background-color:#0d566c;color:#FFFFFF;border-color:#eeeeee;border-style:solid;border-width:0;padding-top:30px;padding-bottom:30px;padding-left:40px;padding-right:40px;text-align:left;margin-left:0;margin-right:0"><!-- wp:image {"align":"left","width":135,"height":41,"sizeSlug":"large","className":"is-style-default"} -->
