...
<div class="ngl-boarding alt is-hidden" data-screen="4">
	...
	<div class="ngl-settings ngl-metabox-flex">
		...
		<div class="ngl-field">
			<?php
				$lists  = newsletterglue_get_option( 'lists', 'campaignmonitor' );
	...
	<div class="ngl-settings ngl-metabox-flex">
		...
		<div class="ngl-field">
			<?php
				$segments = newsletterglue_get_option( 'segments', 'campaignmonitor' );
...
<div class="ngl-boarding alt is-hidden" data-screen="5">
		...
		<div class="ngl-field">
			<?php
				newsletterglue_text_field( array(
					...
					'value'			=> newsletterglue_get_option( 'from_name', 'campaignmonitor' ),
					'class'			=> 'ngl-ajax',
				) );
			?>
		</div>
	...
	<div class="ngl-settings ngl-metabox-flex">
		...
		<div class="ngl-field">
			<?php
				$email = newsletterglue_get_option( 'from_email', 'campaignmonitor' );
				if ( ! $email ) {
