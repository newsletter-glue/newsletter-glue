...
<div class="ngl-header"><?php esc_html_e( 'GetResponse', 'newsletter-glue' ); ?></div>
	...
	<form action="" method="get">
		...
		<?php
			newsletterglue_text_field( array(
				'id' 			=> 'ngl_getresponse_key',
				'placeholder' 	=> esc_html__( 'Enter API Key', 'newsletter-glue' ),
				'value'			=> isset( $integrations['getresponse']['api_key'] ) ? $integrations['getresponse']['api_key'] : '',
				'helper'		=> '<a href="https://app.getresponse.com/api" target="_blank">' . __( 'Get API key', 'newsletter-glue' ) . '</a>',
			) );
		?>
