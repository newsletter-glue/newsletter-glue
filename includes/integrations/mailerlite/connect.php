...
<div class="ngl-header"><?php esc_html_e( 'MailerLite', 'newsletter-glue' ); ?></div>
	...
	<form action="" method="get">
		...
		<?php
			newsletterglue_text_field( array(
				'id' 			=> 'ngl_mailerlite_key',
				'placeholder' 	=> esc_html__( 'Enter API Key', 'newsletter-glue' ),
				'value'			=> isset( $integrations['mailerlite']['api_key'] ) ? $integrations['mailerlite']['api_key'] : '',
				'helper'		=> '<a href="https://app.mailerlite.com/integrations/api/" target="_blank">' . __( 'Get API key', 'newsletter-glue' ) . '</a>',
			) );
		?>
