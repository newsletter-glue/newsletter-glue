...
class NGL_Pro {
	...
	public function add_license_activation_form() {
		...
		<div class="ngl-license-wrap">
			...
			<div class="ngl-license-wrap-success is-hidden">
				<i class="check circle icon"></i>
				<span>
					<?php _e( 'Your license key is now activated.', 'newsletter-glue' ); ?>
					<em><?php _e( 'For future changes, head to <strong>Settings > Pro license</strong>', 'newsletter-glue' ); ?></em>
				</span>
			</div>
